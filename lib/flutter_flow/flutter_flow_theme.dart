...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF191414);
  late Color tertiary = const Color(0xFF1DB954);
  ...
  late Color success = const Color(0xFF1DB954);
  late Color warning = const Color(0xFFFFB300);
  late Color error = const Color(0xFFE91429);
  late Color info = const Color(0xFF1DB954);

  late Color onPrimary = const Color(0xFFFFFFFF);
  late Color primaryContainer = const Color(0x1A1DB954);
  late Color onPrimaryContainer = const Color(0xFF121212);
  late Color onSecondary = const Color(0xFFFFFFFF);
  late Color secondaryContainer = const Color(0x1A191414);
  late Color onSecondaryContainer = const Color(0xFF121212);
  late Color onAccent = const Color(0xFFFFFFFF);
  late Color accentContainer = const Color(0x1A1DB954);
  ...
  late Color onSurfaceVariant = const Color(0xFF535353);
  ...
  late Color onSecondary13 = const Color(0x21FFFFFF);
...
class ThemeTypography extends Typography {
  ...
  String get displayLargeFamily => 'Circular Std';
  ...
  String get displayMediumFamily => 'Circular Std';
  ...
  String get displaySmallFamily => 'Circular Std';
  ...
  String get headlineLargeFamily => 'Circular Std';
  ...
  String get headlineMediumFamily => 'Circular Std';
  ...
  String get headlineSmallFamily => 'Circular Std';
  ...
  String get titleLargeFamily => 'Circular Std';
  ...
  String get titleMediumFamily => 'Circular Std';
  ...
  String get titleSmallFamily => 'Circular Std';
  ...
  String get labelLargeFamily => 'Circular Std';
  ...
  String get labelMediumFamily => 'Circular Std';
  ...
  String get labelSmallFamily => 'Circular Std';
  ...
  String get bodyLargeFamily => 'Circular Std';
  ...
  String get bodyMediumFamily => 'Circular Std';
  ...
  String get bodySmallFamily => 'Circular Std';
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF1DB954);
  late Color alternate = const Color(0xFF282828);
  ...
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF535353);
  ...
  late Color onPrimary = const Color(0xFFFFFFFF);
  late Color primaryContainer = const Color(0x241DB954);
  ...
  late Color onAccent = const Color(0xFFFFFFFF);
  late Color accentContainer = const Color(0x241DB954);
  ...
  late Color surfaceVariant = const Color(0xFF3E3E3E);
  late Color onSurfaceVariant = const Color(0xFFB3B3B3);
  late Color onSuccess = const Color(0xFFFFFFFF);
  late Color onWarning = const Color(0xFF000000);
  late Color onError = const Color(0xFFFFFFFF);
  late Color onInfo = const Color(0xFFFFFFFF);
  ...
  late Color background20 = const Color(0x33121212);
  late Color background80 = const Color(0xCC121212);
  late Color onSecondary13 = const Color(0x21000000);
  late Color surface80 = const Color(0xCC282828);
